...
export const CanvasRevealEffect = ({
  ...
  const combinedClassName = `h-full relative bg-white w-full ${containerClassName || ""}`
  ...
  return (
    <div className={combinedClassName}>
      ...
      {showGradient && <div className="absolute inset-0 bg-gradient-to-t from-green-950 to-[84%]" />}
    </div>
  )
}
